...
//                                             className="object-cover w-16 h-16 rounded-lg me-4"  // Use me-4 instead of mr-4
//                                         />
...
//                                         {taxSysType === "included" ? (
//                                             <span>
//                                                 {((orderSummary.subtotal - orderSummary.discount) || orderSummary.priceAfterDiscount) + orderSummary.delivery} {t("egp")}
//                                             </span>
//                                         ) : (
//                                             <span>
//                                                 {(orderSummary.total + orderSummary.delivery).toFixed(2)} {t("egp")}
//                                             </span>
//                                         )}
//                                     </div>
//                                 </div>
...
const CheckOut = () => {
    ...
    const displayTotal = baseTotal + deliveryFee + paymentFee;
