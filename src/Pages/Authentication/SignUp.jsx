...
placeholder={t("ConfirmYourPassword")}
                                    ...
                                    {errors.general && (
                                        <div className="p-3 text-sm rounded-lg bg-thirdColor text-secoundColor">{errors.general}</div>
                                    )}
                                    {successMessage && (
...
<label className="block mb-2 text-sm font-medium text-gray-700">{t("VerificationCode")}</label>
                                ...
                                {errors.general && (
                                    <div className="p-3 mb-4 text-sm rounded-lg bg-thirdColor text-secoundColor">{errors.general}</div>
                                )}
                                {successMessage && (
